      ...
      <div>
        ...
        {this.state.type === 'add' &&
            <div className="flex items-center justify-end">
                <Button className="normal-case" variant="contained" color="primary" aria-label="Add Category" onClick={(ev) => {
                    ev.stopPropagation();
                    this.handleClickOpen();
                }}>Add Category</Button>
            </div>
        ...
        >
          <DialogTitle id="form-dialog-title">Top Category</DialogTitle>
          <DialogContent>
            <DialogContentText>
              To edit to this category, please enter name here.
            </DialogContentText>
            <TextField
              autoFocus
              margin="dense"
